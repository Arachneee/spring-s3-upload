package org.example.springs3upload.s3.awsmultipart;
...
@RestController
public class S3AWSMultipartController {
    ...
    private final S3AWSMultipartService s3UploadService;

    public S3AWSMultipartController(S3AWSMultipartService s3UploadService) {
